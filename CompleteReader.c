...
/** 
* Loads course and student data from a provided text file and performs basic operations
...
*  @param dst is a pointer to the location where the char* should be stored
*  @param max_length is the maximum length the string will be
*/
void readString(FILE* file, char** dst, int max_length){
...
/**
* Reads text from filename and imports that data into the program
...
/**
* Reads student data from file into a dynamically allocated array of student structs
* @param file is the input file
* @return a pointer to a dynamically allocated array of student structs
*/
Student* readStudents(FILE* file){
...
/**
* Reads course data from file into a dynamically allocated array of course structs 
* @param file is the input file
* @return a pointer to a dynamically allocated array of course structs 
*/
Course* readCourses(FILE* file){
...
/**
* Reads assignment data from file into a dynamically allocated array of assign structs
* @param file is the input file
* @param numAssigns is the number of assignments to be read from the file
* @return a pointer to a dynamically allocated array of assign structs
*/
Assign* readAssigns(FILE* file, int numAssigns){
...
/**
* Reads scores data from file into a dynamically allocated 2D array of ScoreStruct structs
* @param file is the input file
* @param numAssigns is the number of assignments associated with the course
* @return a pointer to an array of pointers to dynamically allocated 1D arrays of grade structs
*/
ScoreStruct** readScores(FILE* file, int numAssigns){
  // Allocate 2D array
...
/**
* Returns a string representation of AcademicLevel enum value
* @param level is the AcademicLevel enum value
* @return a string representing that enum value
*/
...
/**
* Cleanly print assignment data
* @param numAssigns is the number of assignments to be printed
* @param assigns is a pointer to an array of assign structs
*/
void printAssigns(Assign* assigns, int numAssigns){
  int i;
  //printf("Assigns: \n");
...
/**
* Cleanly print grade data
* @param numAssigns is the number of assignments represented in the grade data
* @param grades is a pointer to an array of pointers to arrays of grade structs
*/
void printGrades(ScoreStruct** scores, int numAssigns){
  int i, j;
  //printf("Grades: \n");
...
/**
* Destroys an assignment collection
* @param assigns is a pointer to a pointer to an array of assignments
* @param numAssigns is the number of assignments in the array
*/
...
/**
* Destroys a grade collection
* @param grades is a pointer to the dynamically allocated 2D array
* @param numAssigns is the number of assignments represented in the grade collection
*/
void scoresDestructor(ScoreStruct*** scores, int numAssigns){
	int i, j;
...
/**
* Queries user for an assignment to average grade's for.
* @param course is the course struct to be read from 
*/
...
/**
* Queries user for a student to get the scores for
* @param course is the course struct to be read from
*
*/
...
/**
* Prints student grades in course
* @param course is the course struct to be read from
* @param studentNo is the id of the student to be read
*/
void getStudentScores(Course course, int studentNo){
  double total = 0, average = 0;
  int i;
